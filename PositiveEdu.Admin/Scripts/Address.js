...
function p(a, b, c) {
    ...
    var city = window.document.getElementById("s2");
    var town = window.document.getElementById("s3");
    for (var i = 0; i < city.children.length; i++) {
        console.log(city.children[i].value);
        if (city.children[i].value == b) {
            city.children[i].setAttribute("selected", "selected");
            town.appendChild(new Option(c, c, true, true, c))
        }
    }
}
